...
class HMWP_Models_Files
{
    ...
    public function getOriginalUrl( $url )
    {
        ...
        if( isset($_SERVER['QUERY_STRING']) && !empty( $_SERVER['QUERY_STRING'] ) ){
            ...
            $new_url .= (strpos($new_url, '?') == false ? '?' : '&') . $query ;
        }
    ...
    public function showFile( $url )
    {
        ...
        if ($ext = $this->isFile($new_url) ) {
            ...
            strpos($new_url, HMWP_Classes_Tools::getDefault('hmwp_login_url')) ||
            strpos($new_url, HMWP_Classes_Tools::getDefault('hmwp_lostpassword_url')) ||
            strpos($new_url, HMWP_Classes_Tools::getDefault('hmwp_logout_url')) ||
            strpos($new_url, HMWP_Classes_Tools::getDefault('hmwp_register_url'))) {
        ...
        } elseif (strpos($new_url, '/' . HMWP_Classes_Tools::getDefault('hmwp_wp-json')) !== false && isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] === 'POST' ) {
    ...
    public function handleLogin($url){
        ...
        if ( ! ( HMWP_Classes_Tools::getvalue('action') === 'postpass' && HMWP_Classes_Tools::getIsset('post_password') ) ) {
            ...
            if(strpos($url, HMWP_Classes_Tools::getOption('hmwp_login_url')) ||
                ...
                strpos($url, HMWP_Classes_Tools::getDefault('hmwp_lostpassword_url'))) {
            ...
            } elseif (strpos($url, HMWP_Classes_Tools::getDefault('hmwp_logout_url'))){
