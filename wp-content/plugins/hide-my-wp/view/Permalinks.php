                                ...
                                (function ($) {
                                    ...
                                    $(document).ready(function () {
                                        ...
                                        $(".default_autoload").on('click', function () {
                                            ...
                                            $('select[name="hmwp_emulate_cms"] option[value="<?php echo HMWP_Classes_Tools::getDefault('hmwp_emulate_cms') ?>"]').prop('selected', 'selected');
                                        });
                        ...
                        <div class="hmwp_emulate_cms col-sm-12 row justify-content-center py-4 shadow-none" <?php echo((HMWP_Classes_Tools::getOption('hmwp_mode') == 'default') ? 'style="display:none"' : '') ?>>
                            ...
                            <div class="col-sm-4 px-2 input-group">
                                <select name="hmwp_emulate_cms" class="form-control bg-input mb-1">
                                    ...
                                    <option value="drupal7" <?php selected('drupal7', HMWP_Classes_Tools::getOption('hmwp_emulate_cms')) ?> ><?php echo esc_html__("Drupal 7", 'hide-my-wp') ?></option>
                                    ...
                                    <option value="joomla1" <?php selected('joomla1', HMWP_Classes_Tools::getOption('hmwp_emulate_cms')) ?> ><?php echo esc_html__("Joomla 1.5", 'hide-my-wp') ?></option>
                            ...
                            if (HMWP_Classes_Tools::isGodaddy() ) {
                                ...
                                <div class="col-sm-12 row border-bottom border-light py-3 mx-0 my-3">
                                    ...
                                    <div class="col-sm-8 p-0 input-group">
                                        <input type="text" class="form-control bg-input" name="hmwp_admin_url" value="<?php echo HMWP_Classes_Tools::getOption('hmwp_admin_url') ?>" placeholder="<?php echo HMWP_Classes_Tools::getDefault('hmwp_admin_url') ?>"/>
                ...
                <div id="newlogin" class="card col-sm-12 p-0 m-0 tab-panel">
                    ...
                    <div class="card-body">
                        <?php if (defined('HMWP_DEFAULT_LOGIN') && HMWP_DEFAULT_LOGIN ) {
                            ...
                            echo '<input type="hidden" name="hmwp_login_url" value="' . HMWP_Classes_Tools::getDefault('hmwp_login_url') . '"/>';
                        } else {
                            ?>
                            <div class="col-sm-12 row border-bottom border-light py-3 mx-0 my-3">
                                <div class="col-sm-4 p-0 font-weight-bold">
                                ...
                                <div class="col-sm-8 p-0 input-group">
                                    <input type="text" class="form-control bg-input" name="hmwp_login_url" value="<?php echo HMWP_Classes_Tools::getOption('hmwp_login_url') ?>" placeholder="<?php echo HMWP_Classes_Tools::getDefault('hmwp_login_url') ?>"/>
                            ...
                            <?php if (HMWP_Classes_Tools::isMultisites() ) { ?>
                                <div class="col-sm-12 row border-bottom border-light py-3 mx-0 my-3">
                                    ...
                                    <div class="col-sm-8 p-0 input-group">
                                        <input type="text" class="form-control bg-input" name="hmwp_activate_url" value="<?php echo HMWP_Classes_Tools::getOption('hmwp_activate_url') ?>" placeholder="<?php echo HMWP_Classes_Tools::getDefault('hmwp_activate_url') ?>"/>
                    ...
                    <div class="card-body">
                        ...
                        <?php if (!HMWP_Classes_Tools::isMultisiteWithPath() && !HMWP_Classes_Tools::isNginx() && !HMWP_Classes_Tools::isWpengine() ) { ?>
                            <div class="col-sm-12 row border-bottom border-light py-3 mx-0 my-3">
                                ...
                                <div class="col-sm-8 p-0 input-group">
                                    <input type="text" class="form-control bg-input" name="hmwp_author_url" value="<?php echo HMWP_Classes_Tools::getOption('hmwp_author_url') ?>" placeholder="<?php echo HMWP_Classes_Tools::getDefault('hmwp_author_url') ?>"/>
                        ...
                        <?php } else { ?>
                            <input type="hidden" name="hmwp_author_url" value="<?php echo HMWP_Classes_Tools::getDefault('hmwp_author_url') ?>"/>
                        <?php } ?>
                        <div class="col-sm-12 row mb-1 ml-1 p-2">
                            <div class="checker col-sm-12 row my-2 py-1">
                                <div class="col-sm-12 p-0 switch switch-sm">
                ...
                <div id="ajax" class="card col-sm-12 p-0 m-0 tab-panel">
                    ...
                    <div class="card-body">
                        <div class="col-sm-12 row border-bottom border-light py-3 mx-0 my-3">
                            ...
                            <div class="col-sm-8 p-0 input-group">
                                <input type="text" class="form-control bg-input" name="hmwp_admin-ajax_url" value="<?php echo HMWP_Classes_Tools::getOption('hmwp_admin-ajax_url') ?>" placeholder="<?php echo HMWP_Classes_Tools::getDefault('hmwp_admin-ajax_url') ?>"/>
                ...
                <div id="core" class="card col-sm-12 p-0 m-0 tab-panel">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-12 row border-bottom border-light py-3 mx-0 my-3">
                            ...
                            <div class="col-sm-8 p-0 input-group">
                                <input type="text" class="form-control bg-input" name="hmwp_wp-content_url" value="<?php echo HMWP_Classes_Tools::getOption('hmwp_wp-content_url') ?>" placeholder="<?php echo HMWP_Classes_Tools::getDefault('hmwp_wp-content_url') ?>"/>
                        ...
                        <div class="col-sm-12 row border-bottom border-light py-3 mx-0 my-3">
                            ...
                            <div class="col-sm-8 p-0 input-group">
                                <input type="text" class="form-control bg-input" name="hmwp_wp-includes_url" value="<?php echo HMWP_Classes_Tools::getOption('hmwp_wp-includes_url') ?>" placeholder="<?php echo HMWP_Classes_Tools::getDefault('hmwp_wp-includes_url') ?>"/>
                        ...
                        <div class="col-sm-12 row border-bottom border-light py-3 mx-0 my-3">
                            ...
                            <?php if (!defined('UPLOADS') ) { ?>
                                <div class="col-sm-8 p-0 input-group">
                                    <input type="text" class="form-control bg-input" name="hmwp_upload_url" value="<?php echo HMWP_Classes_Tools::getOption('hmwp_upload_url') ?>" placeholder="<?php echo HMWP_Classes_Tools::getDefault('hmwp_upload_url') ?>"/>
                        ...
                        <div class="col-sm-12 row border-bottom border-light py-3 mx-0 my-3">
                            ...
                            <div class="col-sm-8 p-0 input-group">
                                <input type="text" class="form-control bg-input" name="hmwp_wp-comments-post" value="<?php echo HMWP_Classes_Tools::getOption('hmwp_wp-comments-post') ?>" placeholder="<?php echo HMWP_Classes_Tools::getDefault('hmwp_wp-comments-post') ?>"/>
                        ...
                        <div class="col-sm-12 row border-bottom border-light py-3 mx-1 my-3 hmwp_hide_oldpaths">
                            <div class="col-sm-4 p-1">
                                ...
                                <div class="text-black-50"><?php echo esc_html__("Select the file extensions you want to hide on old paths", 'hide-my-wp'); ?></div>
                            </div>
                            <div class="col-sm-8 p-0 input-group">
                                <select multiple name="hmwp_hide_oldpaths_types[]" class="selectpicker form-control mb-1">
                                    <?php
                                    $alltypes = array('css', 'js', 'php', 'txt', 'html', 'lock', 'xml', 'json');
                                    ...
                                    foreach ( $alltypes as $key ) {
                                        echo '<option value="' . $key . '" ' . (in_array($key, $types) ? 'selected="selected"' : '') . '>' . strtoupper($key) . ' ' . esc_html__('files', 'hide-my-wp') . '</option>';
                                    } ?>
                                </select>
                            </div>
                        ...
                        <div class="col-sm-12 row border-bottom border-light py-3 mx-1 my-3 hmwp_hide_commonfiles">
                            <div class="col-sm-4 p-1">
                                ...
                                <div class="text-black-50"><?php echo esc_html__("Select the files you want to hide on old paths", 'hide-my-wp'); ?></div>
                            </div>
                            <div class="col-sm-8 p-0 input-group">
                                <select multiple name="hmwp_hide_commonfiles_files[]" class="selectpicker form-control mb-1">
                                    <?php
                                    $allfiles = array('wp-config-sample.php', 'readme.html', 'readme.txt', 'install.php', 'license.txt', 'php.ini', 'bb-config.php', 'error_log');
                                    ...
                                    foreach ( $allfiles as $key ) {
                                        echo '<option value="' . $key . '" ' . (in_array($key, $files) ? 'selected="selected"' : '') . '>' . $key . '</option>';
                                    } ?>
                                </select>
                            </div>
                ...
                <div id="plugin" class="card col-sm-12 p-0 m-0 tab-panel">
                    ...
                    <div class="card-body">
                        <div class="col-sm-12 row border-bottom border-light py-3 mx-0 my-3">
                            ...
                            <div class="col-sm-8 p-0 input-group">
                                <input type="text" class="form-control bg-input" name="hmwp_plugin_url" value="<?php echo HMWP_Classes_Tools::getOption('hmwp_plugin_url') ?>" placeholder="<?php echo HMWP_Classes_Tools::getDefault('hmwp_plugin_url') ?>"/>
                            ...
                            <div class="col-sm-12 m-0 p-0 hmw_plugins_mappings">
                                <?php foreach ( $plugins as $plugin => $value ) {
                                    ...
                                    <div class="col-sm-12 row pb-3 m-0 my-1 border-0">
                                        ...
                                        <div class="col-sm-8 p-0 input-group">
                                            <input type="text" class="form-control bg-input" name="hmw_plugins_mapping[<?php echo esc_attr($plugin)?>]" value="<?php echo esc_attr($value) ?>" />
                                        </div>
                                    </div>
                                <?php }?>
                            </div>
                            ...
                            <?php if(count($all_plugins) > (count($plugins) - 1)) { ?>
                                <div class="col-sm-12 row pb-3 m-0 my-1 border-0 hmw_plugins_mapping_select">
                                    ...
                                    <div class="col-sm-12 row pb-3 m-0 my-1 border-0 hmw_plugins_mapping_new" style="display: none">
                                        ...
                                        <div class="col-sm-8 p-0 input-group"><input type="text" class="form-control bg-input" /> </div>
                                    </div>
                ...
                <div id="theme" class="card col-sm-12 p-0 m-0 tab-panel">
                    ...
                    <div class="card-body">
                        <div class="col-sm-12 row border-bottom border-light py-3 mx-0 my-3">
                            ...
                            <div class="col-sm-8 p-0 input-group">
                                <input type="text" class="form-control bg-input" name="hmwp_themes_url" value="<?php echo HMWP_Classes_Tools::getOption('hmwp_themes_url') ?>" placeholder="<?php echo HMWP_Classes_Tools::getDefault('hmwp_themes_url') ?>"/>
                        ...
                        <div class="col-sm-12 row border-bottom border-light py-3 mx-0 my-3">
                            ...
                            <div class="col-sm-8 p-0 input-group">
                                <input type="text" class="form-control bg-input" name="hmwp_themes_style" value="<?php echo HMWP_Classes_Tools::getOption('hmwp_themes_style') ?>" placeholder="<?php echo HMWP_Classes_Tools::getDefault('hmwp_themes_style') ?>"/>
                            ...
                            <div class="col-sm-12 m-0 p-0 hmw_themes_mappings">
                                <?php foreach ( $themes as $theme => $value ) {
                                    ...
                                    <div class="col-sm-12 row pb-3 m-0 my-1 border-0">
                                        ...
                                        <div class="col-sm-8 p-0 input-group">
                                            <input type="text" class="form-control bg-input" name="hmw_themes_mapping[<?php echo esc_attr($theme)?>]" value="<?php echo esc_attr($value) ?>" />
                                        </div>
                                    </div>
                                <?php }?>
                            </div>
                ...
                <div id="api" class="card col-sm-12 p-0 m-0 tab-panel">
                    ...
                    <div class="card-body">
                        <div class="col-sm-12 row border-bottom border-light py-3 mx-0 my-3">
                            ...
                            <div class="col-sm-8 p-0 input-group">
                                <input type="text" class="form-control bg-input" name="hmwp_wp-json" value="<?php echo HMWP_Classes_Tools::getOption('hmwp_wp-json') ?>" placeholder="<?php echo HMWP_Classes_Tools::getDefault('hmwp_wp-json') ?>"/>
                        ...
                        <div class="col-sm-12 row mb-1 ml-1 p-2">
                            <div class="checker col-sm-12 row my-2 py-1">
                                <div class="col-sm-12 p-0 switch switch-sm">
                                    ...
                                    <label for="hmwp_detectors_block"><?php echo esc_html__('Block Theme Detectors Crawlers', 'hide-my-wp'); ?> <em class="text-info">(BETA)</em>
                                    </label>
                ...
                <div id="more" class="card col-sm-12 p-0 m-0 tab-panel">
                    ...
                    <div class="card-body">
                        <div class="col-sm-12 row border-bottom border-light py-3 mx-0 my-3">
                            ...
                            <div class="col-sm-8 p-0 input-group">
                                <input type="text" class="form-control bg-input" name="hmwp_category_base" value="<?php echo HMWP_Classes_Tools::getOption('hmwp_category_base') ?>" placeholder="<?php echo HMWP_Classes_Tools::getDefault('hmwp_category_base') ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 row border-bottom border-light py-3 mx-0 my-3">
                            ...
                            <div class="col-sm-8 p-0 input-group">
                                <input type="text" class="form-control bg-input" name="hmwp_tag_base" value="<?php echo HMWP_Classes_Tools::getOption('hmwp_tag_base') ?>" placeholder="<?php echo HMWP_Classes_Tools::getDefault('hmwp_tag_base') ?>"/>
                            </div>
                        </div>
                    </div>
                </div>
