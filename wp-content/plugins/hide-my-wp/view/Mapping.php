                ...
                <input type="hidden" name="action" value="hmwp_mappsettings"/>
                        ...
                        <?php if (HMWP_Classes_Tools::getOption('hmwp_mode') == 'default' ) { ?>
                            <div class="card-body">
                                <div class="col-sm-12 border-0 py-3 mx-0 my-3 text-black-50 text-center">
                                    <?php echo sprintf(esc_html__('First, you need to activate the %sSafe Mode%s or %sGhost Mode%s', 'hide-my-wp'), '<a href="'.HMWP_Classes_Tools::getSettingsUrl('hmwp_permalinks').'">', '</a>', '<a href="'.HMWP_Classes_Tools::getSettingsUrl('hmwp_permalinks').'">', '</a>') ?>
                                </div>
                            </div>
                        <?php } else { ?>
                            <div class="card-body">
                    ...
                    <div id="url" class="card col-sm-12 p-0 m-0 tab-panel">
                            ...
                            <?php } else { ?>
                                ...
                                <div class="my-2 p-2 alert-danger">
                                    <?php echo sprintf(esc_html__("It's important to only include internal URLs from Frontend source code after you activate the Safe Mode or Ghost Mode within %s.", 'hide-my-wp'), HMWP_Classes_Tools::getOption('hmwp_plugin_name')); ?>
                                </div>
