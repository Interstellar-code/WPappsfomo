...
class HMWP_Controllers_Brute extends HMWP_Classes_FrontController
{
    ...
    public function __construct()
    {
        ...
        if(HMWP_Classes_Tools::getOption('hmwp_bruteforce_register')) {
            ...
            if(HMWP_Classes_Tools::getOption('hmwp_bruteforce_woocommerce') && !HMWP_Classes_Tools::getOption('brute_use_captcha_v3')) {
                add_filter('woocommerce_registration_errors', array($this, 'hmwp_check_registration'), 99, 3);
            }
        }
        ...
        if (HMWP_Classes_Tools::getOption('brute_use_math')) {
            ...
            if(HMWP_Classes_Tools::getOption('hmwp_bruteforce_register')) {
                ...
                if(HMWP_Classes_Tools::getOption('hmwp_bruteforce_woocommerce')) {
                    add_filter('woocommerce_register_form', array($this->model, 'brute_math_form'), 99);
                }
            }
            if(HMWP_Classes_Tools::getOption('hmwp_bruteforce_woocommerce')) {
            ...
            if(HMWP_Classes_Tools::getOption('hmwp_bruteforce_register')) {
                ...
                if(HMWP_Classes_Tools::getOption('hmwp_bruteforce_woocommerce')) {
                    add_filter('woocommerce_register_form', array($this->model, 'woocommerce_brute_recaptcha_form'), 99);
                }
            }
            if(HMWP_Classes_Tools::getOption('hmwp_bruteforce_woocommerce')) {
            ...
            if(HMWP_Classes_Tools::getOption('hmwp_bruteforce_woocommerce')) {
                add_filter('woocommerce_login_form', array($this->model, 'woocommerce_brute_recaptcha_form_v3'), 99);
            }
        }
