...
class Ai1wmpe_Import_PCloud {

	public static function execute( $params, Ai1wmpe_PCloud_Client $pcloud = null ) {

		// Set progress
		Ai1wm_Status::info( __( 'Creating an empty archive...', AI1WMPE_PLUGIN_NAME ) );
		...
		// Get file URL
		$params['file_url'] = $pcloud->get_file_url( $params['file_id'] );

		// Set progress
		Ai1wm_Status::info( __( 'Done creating an empty archive.', AI1WMPE_PLUGIN_NAME ) );
