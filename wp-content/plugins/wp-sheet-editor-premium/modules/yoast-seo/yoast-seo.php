			...
			foreach ( $post_types as $post_type ) {
				...
				$editor->args['columns']->register_item(
					...
					array_merge(
						array(
							'data_type'         => 'meta_data',
							'column_width'      => 300,
							'title'             => esc_html__( 'SEO Title', 'vg_sheet_editor' ),
				...
				$editor->args['columns']->register_item(
					...
					array_merge(
						array(
							'data_type'         => 'meta_data',
							'column_width'      => 300,
							'title'             => esc_html__( 'SEO Description', 'vg_sheet_editor' ),
							'supports_formulas' => true,
						),
						$tax_settings
					)
				...
				$editor->args['columns']->register_item(
					...
					array_merge(
						array(
							'data_type'         => 'meta_data',
							'column_width'      => 120,
							'title'             => esc_html__( 'SEO Keyword', 'vg_sheet_editor' ),
							'supports_formulas' => true,
						),
						$tax_settings
					)
				...
				$editor->args['columns']->register_item(
					...
					array_merge(
						array(
							'data_type'         => 'meta_data',
							'column_width'      => 120,
							'title'             => esc_html__( 'SEO FB title', 'vg_sheet_editor' ),
							'supports_formulas' => true,
						),
						$tax_settings
					)
				...
				$editor->args['columns']->register_item(
					...
					array_merge(
						array(
							'data_type'         => 'meta_data',
							'column_width'      => 120,
							'title'             => esc_html__( 'SEO FB description', 'vg_sheet_editor' ),
							'supports_formulas' => true,
						),
						$tax_settings
					)
				...
				$editor->args['columns']->register_item(
					...
					array_merge(
						array(
							'data_type'             => 'meta_data',
							'column_width'          => 120,
							'title'                 => esc_html__( 'SEO FB image', 'vg_sheet_editor' ),
							'type'                  => 'boton_gallery',
							'supports_formulas'     => true,
							'supports_sql_formulas' => false,
				...
				$editor->args['columns']->register_item(
					...
					array_merge(
						array(
							'data_type'         => 'meta_data',
							'column_width'      => 120,
							'title'             => esc_html__( 'SEO TW title', 'vg_sheet_editor' ),
							'supports_formulas' => true,
						),
						$tax_settings
					)
				...
				$editor->args['columns']->register_item(
					...
					array_merge(
						array(
							'data_type'         => 'meta_data',
							'column_width'      => 120,
							'title'             => esc_html__( 'SEO TW description', 'vg_sheet_editor' ),
							'supports_formulas' => true,
						),
						$tax_settings
					)
				...
				$editor->args['columns']->register_item(
					...
					array_merge(
						array(
							'data_type'             => 'meta_data',
							'column_width'          => 120,
							'title'                 => esc_html__( 'SEO TW image', 'vg_sheet_editor' ),
							'type'                  => 'boton_gallery',
							'supports_formulas'     => true,
							'supports_sql_formulas' => false,
							'save_value_callback'   => array( $this, 'save_opengraph_image' ),
				...
				$editor->args['columns']->register_item(
					...
					array_merge(
						array(
							'data_type'         => 'meta_data',
							'column_width'      => 120,
							'title'             => esc_html__( 'SEO Canonical URL', 'vg_sheet_editor' ),
							'supports_formulas' => true,
						),
						$tax_settings
					)
				...
				$editor->args['columns']->register_item(
					...
					array_merge(
						array(
							'data_type'         => 'meta_data',
							'column_width'      => 120,
							'title'             => esc_html__( 'SEO No Index', 'vg_sheet_editor' ),
							'supports_formulas' => true,
							'formatted'         => array(
								'type'              => 'checkbox',
				...
				$editor->args['columns']->register_item(
					...
					array(
						'data_type'         => 'meta_data',
						'column_width'      => 150,
						'title'             => esc_html__( 'SEO', 'vg_sheet_editor' ),
				...
				if ( $editor->provider->is_post_type ) {
					...
					$editor->args['columns']->register_item(
						...
						array_merge(
							array(
								'data_type'         => 'meta_data',
								'column_width'      => 200,
								'title'             => esc_html__( 'SEO Breadcrumbs Title', 'vg_sheet_editor' ),
								'supports_formulas' => true,
							),
							$tax_settings
						)
					...
					// SEO Estimated Reading Time (Min)
					$editor->args['columns']->register_item(
						...
						array_merge(
							array(
								'data_type'         => 'meta_data',
								'column_width'      => 150,
								'title'             => esc_html__( 'SEO Estimated Reading Time (Min)', 'vg_sheet_editor' ),
								'supports_formulas' => true,
								'value_type'        => 'number',
							),
							$tax_settings
					...
					// SEO Content Score (read-only number)
					$editor->args['columns']->register_item(
						...
						array_merge(
							array(
								'data_type'         => 'meta_data',
								'column_width'      => 120,
								'title'             => esc_html__( 'SEO Content Score', 'vg_sheet_editor' ),
								'supports_formulas' => false,
								'is_locked'         => true,
								'allow_to_save'     => false,
								'value_type'        => 'number',
					...
					$editor->args['columns']->register_item(
						...
						array_merge(
							array(
								'data_type'         => 'meta_data',
								'column_width'      => 150,
								'title'             => esc_html__( 'SEO WordProof Timestamp', 'vg_sheet_editor' ),
								'supports_formulas' => true,
							),
							$tax_settings
						)
					);
					// SEO Is Cornerstone (checkbox)
					$editor->args['columns']->register_item(
						...
						array_merge(
							array(
								'data_type'         => 'meta_data',
								'column_width'      => 150,
								'title'             => esc_html__( 'SEO Is Cornerstone', 'vg_sheet_editor' ),
								'supports_formulas' => true,
								'formatted'         => array(
									'type'              => 'checkbox',
									'checkedTemplate'   => '1',
					...
					// SEO Meta Robots Advanced (multi-select)
					$editor->args['columns']->register_item(
						...
						array_merge(
							array(
								'data_type'             => 'meta_data',
								'column_width'          => 200,
								'title'                 => esc_html__( 'SEO Meta Robots Advanced', 'vg_sheet_editor' ),
								'supports_formulas'     => true,
								'supports_sql_formulas' => false,
					...
					// SEO Inclusive Language Score (read-only number)
					$editor->args['columns']->register_item(
						...
						array_merge(
							array(
								'data_type'         => 'meta_data',
								'column_width'      => 150,
								'title'             => esc_html__( 'SEO Inclusive Language Score', 'vg_sheet_editor' ),
								'supports_formulas' => false,
								'is_locked'         => true,
								'allow_to_save'     => false,
								'value_type'        => 'number',
					...
					foreach ( $primary_taxonomies as $taxonomy ) {
						...
						$editor->args['columns']->register_item(
							...
							array(
								...
								'title'                 => sprintf( esc_html__( 'SEO Primary %s', 'vg_sheet_editor' ), esc_html( $taxonomy->labels->singular_name ) ),
								'supports_formulas'     => true,
								'supports_sql_formulas' => false,
								'formatted'             => array(
									'type'         => 'autocomplete',
