...
/*
	...
	Domain Path: /lang
	@fs_premium_only /modules/user-path/send-user-path.php, /modules/acf/, /modules/advanced-filters/, /modules/columns-renaming/, /modules/custom-post-types/, /modules/formulas/, /modules/custom-columns/, /modules/spreadsheet-setup/, /modules/woocommerce/, /modules/universal-sheet/, /modules/yoast-seo/, /modules/wpml/, /modules/posts-templates/, /modules/columns-manager/, /modules/active-users/,  /modules/wp-sheet-editor/views/whats-new/, /modules/wp-sheet-editor/inc/integrations/notifier.php,/modules/wp-sheet-editor/inc/teasers/google-sheets.php,/modules/wp-sheet-editor/inc/teasers/ai.php,/modules/wp-sheet-editor/inc/providers/custom_table.php,/modules/wp-sheet-editor/inc/integrations/extensions.json,  /whats-new/
...
?>
		...
		function after_core_init() {
			if ( version_compare( VGSE()->version, '2.26.0' ) < 0 ) {
